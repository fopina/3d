...
- When asked to generate an OpenSCAD render or preview image, run the OpenSCAD CLI render command and, if it fails in the sandbox, retry it with escalation before reporting failure.
